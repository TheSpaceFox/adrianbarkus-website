...
* add hero image to 70% cost reduction case study ([8080766](https://github.com/TheSpaceFox/adrianbarkus-website/commit/8080766cae72cd7ab3885d4504be3cbbff4e26d4))
* add hero image to Dynamics 365 replacement case study ([c466bc1](https://github.com/TheSpaceFox/adrianbarkus-website/commit/c466bc1c45200a4208cd19b5072eca9ec8d27b16))
* add hero image to Fairfax Media case study ([8f225fd](https://github.com/TheSpaceFox/adrianbarkus-website/commit/8f225fd6cdb064003183418293380578f64ffd18))
* add hero image to IndiFind case study ([06a73b6](https://github.com/TheSpaceFox/adrianbarkus-website/commit/06a73b640e86efa6cf7dbfbab5a3e567af09f6c7))
* add hero image to Moneyspot case study ([265ab1e](https://github.com/TheSpaceFox/adrianbarkus-website/commit/265ab1eab311f055c1a8d2c33c1baf855ff6e4e1))
* add hero image to New Horizons case study ([4c279d0](https://github.com/TheSpaceFox/adrianbarkus-website/commit/4c279d0d1d40c710ece99b1cc2a55fe8f71341d2))
* add hero image to Salesforce replacement case study ([f27282a](https://github.com/TheSpaceFox/adrianbarkus-website/commit/f27282a7a1093392cb9dc502ec4521b6b213fe22))
* add hero image to SiteMinder case study ([80a283f](https://github.com/TheSpaceFox/adrianbarkus-website/commit/80a283f3f570648d620d5ba7907c7de6ea15ca36))
* add hero image to SUEZ case study ([b9776cf](https://github.com/TheSpaceFox/adrianbarkus-website/commit/b9776cf445d30781e9e4cd4e8a3457f8bb7ca795))
* add hero image to WGEA case study ([913d066](https://github.com/TheSpaceFox/adrianbarkus-website/commit/913d066c495c6933448751ff6751172ab1942229))
* add hero image to Woolworths case study ([5779f3a](https://github.com/TheSpaceFox/adrianbarkus-website/commit/5779f3a9c2d53a0d2951b366d4528922387f2d70))
* consolidate all booking CTAs to discovery-call link ([b91a983](https://github.com/TheSpaceFox/adrianbarkus-website/commit/b91a983e1525eec0dabbbb09ed685cd5e6178b2e))
* hide serviceType badge on Woolworths case study; remove unused placeholder ([62b8040](https://github.com/TheSpaceFox/adrianbarkus-website/commit/62b804056058a1e961e0a48770dfcd4c96196184))
* move input bar inline on /ask empty state ([aa67dc8](https://github.com/TheSpaceFox/adrianbarkus-website/commit/aa67dc803542872ebbacce86357e3792868f3cd1))
...
* replace home page case studies with real linked entries ([6e899ed](https://github.com/TheSpaceFox/adrianbarkus-website/commit/6e899ed02d72bee2fcbf4e2f5c3cda8315510942))
* replace per-card CTAs with single section CTA in Offers ([e60857e](https://github.com/TheSpaceFox/adrianbarkus-website/commit/e60857e82473681c19e1f60cb3427f877689f6a6))
...
* lift /ask input bar off bottom edge on desktop ([b9cd8e7](https://github.com/TheSpaceFox/adrianbarkus-website/commit/b9cd8e7ff4f28d811844c84116750ef3a2d8ebe3))
* lift fixed input bar above device safe area on /ask page ([93f3622](https://github.com/TheSpaceFox/adrianbarkus-website/commit/93f36228af397b54a8e22ceabfa75508bfb9cd74))
...
* update hero images for Moneyspot and WGEA case studies ([8022bab](https://github.com/TheSpaceFox/adrianbarkus-website/commit/8022babb337dbdbcbbd5f48a1c4d63862c6ab3fa))
* update Salesforce case study hero image ([e14ba42](https://github.com/TheSpaceFox/adrianbarkus-website/commit/e14ba427af0387a3ec2aea17b4f1a3cfaf0d1a2f))
* update Salesforce case study hero image to Choice(2) ([2996286](https://github.com/TheSpaceFox/adrianbarkus-website/commit/2996286de786b86aeefe395c9b39db38d1a8e028))
* update WGEA case study hero image to WEGA(1) ([b1281a6](https://github.com/TheSpaceFox/adrianbarkus-website/commit/b1281a633993ce7fbb1570e0e3b95165867b05b4))
