      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto min-w-0 px-4 sm:px-6 md:px-12 pt-24 md:pt-0">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-tight tracking-tight break-words max-w-4xl mx-auto line-clamp-2"
          >
